...
\begin{tabular}{|c|c|c|c|}
    \hline
    electric charge&電荷&electric filed&電場 \\
    \hline
    \multicolumn{2}{|c|}{opposites attract}&\multicolumn{2}{c|}{異性相吸}   \\
    \hline
    \multicolumn{2}{|c|}{likes repel}&\multicolumn{2}{c|}{同性相斥}\\
    \hline
    semi conductor&半導體 &linear charge&線電荷\\
    \hline
    surface charge&面電荷& volume charge & 體電荷 \\
    \hline
    \multicolumn{2}{|c|}{electromotive force/emf}&\multicolumn{2}{c|}{電動勢$ \varepsilon $}   \\
    \hline
    \multicolumn{2}{|c|}{voltage drop}&\multicolumn{2}{c|}{電壓降}\\
    \hline
    \multicolumn{2}{|c|}{terminal voltage}&\multicolumn{2}{c|}{端電壓}\\
    \hline
    node&節點&branch&支路\\ 
    \hline
    loop&迴路&mesh&網目  \\
    ...
    multiplier&倍增器 & &  \\
    \hline
    \multicolumn{2}{|c|}{series circuit}&\multicolumn{2}{c|}{串聯電路}   \\
    \hline
    \multicolumn{2}{|c|}{parallel circuit}&\multicolumn{2}{c|}{並聯電路}   \\
    \hline
    flux&通量&electric flux&電場通量\\
    \hline
\end{tabular}
\end{narmalsize}
